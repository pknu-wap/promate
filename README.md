...
<p align="center">
  <a href="[https://promate-kappa.vercel.app/](https://promate-kappa.vercel.app/login)"><strong>🔗 PRO:MATE 서비스 이용하기</strong></a>
</p>

---

## 📌 프로젝트 소개
**PRO:MATE**는 프로젝트, 스터디, 공모전 등 다양한 목적의 팀을 빌딩하고 성공적인 협업을 완수할 수 있도록 돕는 올인원 플랫폼입니다. 

기존 협업 툴과 달리, 팀 프로젝트에서 자주 발생하는 **무임승차 문제**와 **팀원 검증의 한계**를 해결하기 위해 지원자의 과거 프로젝트 수행 데이터(태스크 완료율)와 팀원들의 동료 평가 점수를 결합한 **신뢰 지표**를 제공하여 건강하고 투명한 팀 빌딩 생태계를 구축합니다.
...
### 📝 Vs. Notion
* **직관적인 관리**: 복잡한 템플릿이나 문서 정리 없이도 프로젝트 및 Task 관리를 직관적으로 수행할 수 있습니다.
* **시각화된 내역**: 본인이 참여한 프로젝트와 과거 작업 내역을 한눈에 바로 파악할 수 있습니다.
* **데이터 기반 팀 매칭**: 팀원을 모집할 때, 지원자의 이전 프로젝트 이력과 수행 Task를 기반으로 검증된 신뢰도를 먼저 확인하고 선발할 수 있습니다.
